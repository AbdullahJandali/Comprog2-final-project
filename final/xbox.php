...
<!DOCTYPE html>
<head>
	<title>Introducing Xbox one S</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="stylesheet" type="text/css" href="stylexbox.css">
...
<!-- <a class="bts" href="ps4.html">PS4</a><a class="bts" href="#home">VR</a><a class="bts" href="#home">Help</a> -->
		<div class="inner">
			...
			<section  class="os-animation" data-os-animation="bounceInUp" data-os-animation-delay="0s">
					<img class="logo" src="https://img-prod-cms-rt-microsoft-com.akamaized.net/cms/api/am/imageFileData/RW4ESm?ver=c63e">
			</section>
	...
	<h1 class="specs">Introducing the Xbox One.
Now Faster and much powerful than ever before<br>
1TB hard drive
All the greatest games, TV, music and more.</h1><br>
	<img class="slim" src="https://www.bright.nl/sites/default/files/styles/article_940_528/public/content/images/2016/07/19/xboxones_0.jpg?itok=7q9ylHDq"></img>
	<h1 class="only">Only on Xbox One</h1><h1 class="only">You've come to the right place.<br> Exclusive games take you on incredible journeys,<br> from critically acclaimed indies to award-winning AAA hits.</h1><img class="war" src="https://media.giphy.com/media/c1AQTpOyZEn5u/giphy.gif" >
	<h1 class="Horizon">Best Exclusive Games.<br><br>
Offering Special Experience.</h1><br><img class="Hori" src="https://media.giphy.com/media/6cDkEJUeoPF72/giphy.gif"><br>
<br>
<br>
...
<img class="headset" src="https://www.blokker.nl/p/xbox-one-turtle-beach-elite-800x-gaming-headset/1424209/images/full/1424209.jpg"></img><br><br>
<h1 class="cont">XboxOne Controller</h1>
<h1 class="ds">
The XboxOne Wireless Controller  defines this generation of play, combining revolutionary features and comfort with intuitive, precision controls. Evolved analog sticks and trigger buttons allow for unparalleled accuracy with every move while innovative technologies offer exciting ways to experience your games and share your greatest moments.</h1>
<img class="ds4" src="https://c1.eb-cdn.com.au/website/videos/images/screenshots/217314_screenshot_04_l.jpg">
...
<section class="ndintro">
	<!-- <img src="http://mapinstitute.org/data/wallpapers/126/im58872990.png" --><div  class="info">© 2018 Microsoft Interactive Entertainment LLC</div>
</secction>

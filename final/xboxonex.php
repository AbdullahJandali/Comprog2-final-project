...
<!DOCTYPE html>
<head>
	<title>Introducing Xbox one X</title>
...
<!-- <a class="bts" href="ps4.html">PS4</a><a class="bts" href="#home">VR</a><a class="bts" href="#home">Help</a> -->
	...
	<h1 class="specs">Introducing the Xbox One X.
Now Faster and much powerful than ever before<br>
1TB hard drive
All the greatest games, TV, music and more.</h1><br>
	<img class="slim" src="https://cdn.mos.cms.futurecdn.net/4sRDKPFfh9ztZkMG5KqART.jpg"></img>
	<h1 class="only">Only on Xbox One X</h1><h1 class="only">You've come to the right place.<br> Exclusive games take you on incredible journeys,<br> from critically acclaimed indies to award-winning AAA hits.</h1><img class="war" src="https://media.giphy.com/media/c1AQTpOyZEn5u/giphy.gif" >
